    ...
    return (
        <div ref={containerRef} className="relative bg-transparent text-foreground min-h-[300vh] py-24 film-grain">
            ...
            <div className="absolute inset-0 z-10 overflow-hidden pointer-events-none">
                <CinematicPhoto yParallax={y1} top="top-[10%]" left="left-[5%]" w="w-48 md:w-64" h="h-64 md:h-80" rounded="rounded-lg" text="Photo 1" src="/assets/image1.jpeg" />
                <CinematicPhoto yParallax={y2} top="top-[30%]" right="right-[5%]" w="w-56 md:w-72" h="h-72 md:h-96" rounded="rounded-lg" text="Photo 2" src="/assets/image2.jpg.jpeg" />
                <CinematicPhoto yParallax={y3} top="top-[60%]" left="left-[10%]" w="w-64 md:w-80" h="h-64 md:h-80" rounded="rounded-full" text="Photo 3" src="/assets/video3.mp4" />
                <CinematicPhoto yParallax={y1} top="top-[80%]" right="right-[15%]" w="w-48 md:w-64" h="h-64 md:h-80" rounded="rounded-lg" text="Photo 4" src="/assets/video4.mp4" />
            </div>
        </div>
    );
}
